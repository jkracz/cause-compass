            ...
            <div className="space-y-6">
              <section>
                ...
                <p className="text-muted-foreground">
                  By accessing and using Cause Compass, you accept and agree to be bound by the terms and provision of
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-3">
                  Permission is granted to temporarily use Cause Compass for personal, non-commercial transitory viewing
              ...
              <section>
                <h2 className="text-xl font-semibold mb-3">5. Nonprofit Information</h2>
                <p className="text-muted-foreground">
                  While we strive to provide accurate and up-to-date information about nonprofits, we cannot guarantee
                  the completeness or accuracy of all information. Users should verify information independently before
                  making donations or commitments.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold mb-3">6. Prohibited Uses</h2>
                <p className="text-muted-foreground mb-3">You may not use our service:</p>
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  law, this Company excludes all representations, warranties, conditions and terms related to our
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  In no event shall Cause Compass or its suppliers be liable for any damages (including, without
                  limitation, damages for loss of data or profit, or due to business interruption) arising out of the
                  use or inability to use the materials on Cause Compass's website.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  If you have any questions about these Terms & Conditions, please contact us through our website or
                  support channels.
                </p>
              </section>
            </div>
