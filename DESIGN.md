...
- **Label** (Archivo, 600, 11px, `letter-spacing: 0.32em`, uppercase): Kickers, scope tags, "Browse:", "Currently serving". The small caps that mark what _kind_ of thing follows.
...
**The No-Volume Rule.** Editorial labels never imply a publication cadence. No "Vol. X", no week numbers, no "On the cultural calendar"-style affectations. Kickers describe section _kind_ ("Browse by cause", "Cause of the week"), not editorial calendars.
